/* jscpd:ignore-start */
/**
 * Test helper: a local chat-completions stand-in replaying scripted
 * behaviors per request, mirroring the `llm-deepseek` mock server so the
 * two adapters stay wire-assertable in exactly the same shape.
 */
